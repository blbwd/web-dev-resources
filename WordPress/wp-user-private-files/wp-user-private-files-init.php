<?php
/*
Plugin Name: WP User Private Files 
Description: Plugin to manage private files for users. You can upload files for your users to access, files are only viewable/downloadable for the assigned users.
Author: Sanjay Bhowmick
Author URI: https://www.sanjaybhowmick.com
License: GPL
Version: 1.0
...
function upf_save_post($post_id, $post = null) {
	...
	if(!empty($_FILES['upf_file']['name'])) {
		...
		$supported_types = array('application/pdf', 'text/plain', 'application/msword', 'application/vnd.ms-excel', 'application/vnd.ms-powerpoint', 'application/zip', 'image/gif', 'image/png', 'image/jpg', 'image/jpg');
...
add_shortcode('wpuserfiles', 'upf_list_user_files');
